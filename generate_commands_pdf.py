...
def create_commands_pdf(filename="TelePilot_Bot_All_Commands_CheatSheet.pdf"):
    ...
    admin_data = [
        ...
        [Paragraph("<code>/checkownership &lt;phone&gt;</code>", cell_bold), Paragraph("Connects via MTProto and checks if account is owner/creator or admin of any groups or channels.", cell_text), Paragraph("<code>/checkownership +919876543210</code>", cell_desc)],
